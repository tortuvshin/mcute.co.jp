      ...
      <md-table>
        ...
        <md-table-body>
          ...
          <md-table-row v-if="projects.length <= 0">
              <md-table-cell colspan="5" class="text-center no-result-text">No Finished Job</md-table-cell>
          </md-table-row>
          <finished-row v-for="project in projects" :project="project"></finished-row>
        </md-table-body>
      </md-table>
