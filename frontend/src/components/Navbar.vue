	...
	<nav class="navbar-default navbar-inverse navbar navbar-inner navbar-fixed-top" :class="{'home-navbar-inner': isHomePage, 'home-navbar': isHomePage}" id="navbar">
	   <div class="container">
	      <div class="navbar-header">
	         ...
	         <router-link class="navbar-brand" :class="{'home-navbar-brand': isHomePage}" to="/"><i class="fa fa-algolia" aria-hidden="true"></i><span class="title"> WorkFlow Matching</span></router-link>
	      </div>
