<template>
    <md-table-row>
      ...
      <md-table-cell class="project-winbid-bidder text-center">{{project.winBid.bidder.firstName + " " +  project.winBid.bidder.lastName}}</md-table-cell>
      <md-table-cell class="project-winbid-price text-center">${{project.winBid.bidPrice}}</md-table-cell>
