<template>
	<div class="openTable">
      ...
      <md-toolbar v-show="!isSearch">
        <h1 class="md-title">Open Jobs</h1>
      ...
      <md-table>
        ...
        <md-table-body>
          ...
          <md-table-row v-if="projects.length <= 0">
              <md-table-cell colspan="5" class="text-center no-result-text">No Open Project</md-table-cell>
          </md-table-row>
          <open-row v-for="project in projects" :project="project"></open-row>
        </md-table-body>
      </md-table>
